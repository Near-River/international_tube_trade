...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="${ctx}/manage">首页</a><span class="crumb-step">&gt;</span><span>产品发布</span>
            </div>
        </div>
                ...
                <form action="${ctx}/manage/product/save" method="post" id="myform" name="myform"
                    ...
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text required" id="pname" name="pname" size="50" type="text">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th>产品简介：</th>
                            <td><textarea name="pdesc" id="pdesc" cols="30"></textarea></td>
                        </tr>
                        <tr>
                            <th></th>
                            <td>
