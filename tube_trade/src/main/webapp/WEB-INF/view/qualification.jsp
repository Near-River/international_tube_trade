        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <ul class="uk-breadcrumb">
                    ...
                    <li class="uk-active"><span>Qualification</span></li>
                </ul>

                <!--qualification show begin-->
                <div id="productsbox">
                    <div class="uk-grid uk-container-center uk-grid-width-1-3" data-uk-grid-margin>
                        <div>
                            <div class="uk-panel uk-panel-box uk-block-muted uk-animation-hover uk-animation-scale tubebox">
                                <div class="uk-panel-teaser">
                                    <a href="${ctx}/images/qualifiication/001.JPG" data-uk-lightbox="{group:'group1'}">
                                        <img src="${ctx}/images/qualifiication/001.JPG" class="gallery2" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="uk-panel uk-panel-box uk-block-muted uk-animation-hover uk-animation-scale tubebox">
                                <div class="uk-panel-teaser">
                                    <a href="${ctx}/images/qualifiication/002.JPG" data-lightbox-type="image"
                                       data-uk-lightbox="{group:'group1'}">
                                        <img src="${ctx}/images/qualifiication/002.JPG" class="gallery2" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="uk-panel uk-panel-box uk-block-muted uk-animation-hover uk-animation-scale tubebox">
                                <div class="uk-panel-teaser">
                                    <a href="${ctx}/images/qualifiication/003.JPG" data-lightbox-type="image"
                                       data-uk-lightbox="{group:'group1'}">
                                        <img src="${ctx}/images/qualifiication/003.JPG" class="gallery2" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="uk-grid uk-container-center uk-grid-width-1-3" data-uk-grid-margin>
                        <div>
                            <div class="uk-panel uk-panel-box uk-block-muted uk-animation-hover uk-animation-scale tubebox">
                                <div class="uk-panel-teaser">
                                    <a href="${ctx}/images/qualifiication/004.JPG" data-lightbox-type="image"
                                       data-uk-lightbox="{group:'group1'}">
                                        <img src="${ctx}/images/qualifiication/004.JPG" class="gallery2" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="uk-panel uk-panel-box uk-block-muted uk-animation-hover uk-animation-scale tubebox">
                                <div class="uk-panel-teaser">
                                    <a href="${ctx}/images/qualifiication/005.JPG" data-lightbox-type="image"
                                       data-uk-lightbox="{group:'group1'}">
                                        <img src="${ctx}/images/qualifiication/005.JPG" class="gallery2" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="uk-panel uk-panel-box uk-block-muted uk-animation-hover uk-animation-scale tubebox">
                                <div class="uk-panel-teaser">
                                    <a href="${ctx}/images/qualifiication/006.JPG" data-lightbox-type="image"
                                       data-uk-lightbox="{group:'group1'}">
                                        <img src="${ctx}/images/qualifiication/006.JPG" class="gallery2" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
